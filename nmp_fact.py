...
import timeit
import pdb
from dataset_fact import data_load
...
def test(model,
    ...
    # print("Test batch number", test_batch_count)
        ...
        memory_start_time = timeit.default_timer()
        ...
        # memory_time = timeit.default_timer() - memory_start_time
        # # print("Total memory time elapsed: {:.2f}s".format(memory_time))

        # used_memory_total_time = gnn_time + memory_time
        # not_used_memory_total_time = gnn_time + test_batch_count * memory_time
        # print("Used memory total time: {:.6f}s".format(used_memory_total_time))
        # print("Not used memory total time: {:.6f}s".format(not_used_memory_total_time))
    ...
    acc, original_macro_p, original_macro_r, original_macro_f1, original_micro_f1, original_num_of_nodes,pred, logits_tensor = orignal_evaluate(
        model.embedding_encoder,
        test_dataset,
        test_subgraph_loader,
        training_embedding,
